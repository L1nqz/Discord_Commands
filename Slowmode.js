const command = require('../command')//alex's basic command handler 
const { prefix } = require('../config.json')//where your prefix
const Discord = require('discord.js')//npm i discord.js
module.exports = (client) => {

    command(client, ['slow', 'slowmode'], (message) => {//using alex's basic command handler
